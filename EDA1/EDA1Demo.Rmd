...
1. What does the protocol or study plan say is purpose of the data collection?
   ...
   * The purpose of the data is to understand status and trends in upland vegetation.Specifically, the protocol narrative states: 
...
1. What is the geographical span of the dataset? Are there major divisions within that span (e.g., park units, lakes, watersheds, habitats)? 
   ...
   * These data are collected in 4 different shrubland communities across six parks. Four of the parks are Mojave Desert (LAKE, MOJA, JOTR, MANZ) and two are Great Basin (GRBA, PARA). 
...
1. What are the primary goals of the data collection?
   ...
   * To track changes in vegetation and soils. Monitoring questions include 1)	How is structure and composition of vegetation changing over time in network parks? 2)	How are soil surface properties, chemistry, and hydrologic function changing over time? 3)	How are the abundance, structure, and composition of biological soil crusts (BSC) changing over time? 4)	What relationships are observed between soil properties, invasive species, and plant community characteristics?
...
1. What constitutes an “observation” for this dataset? By this definition, how many observations are in the dataset?
   ...
   * An "observation" takes on different forms for a given SOP. For LPI, an observation is a layer type per pin drop. For basal gaps and canopy gaps it is a start point and end point along a 50 m line. For invasive plants it is presence/absence, phenology type, and disturbance type per quadrat on a 50 m line.
